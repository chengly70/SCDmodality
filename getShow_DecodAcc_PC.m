%show indiv decode in PC ; save_flag=1, =>create Decoding Accuracy mat file: DecodAcc_PC.mat
...
indWind=9; %index from 1,..,20; ALL are bad for PC
...
if(save_flag)
    save DecodAcc_PC DecA_ND DecA_Bic DecA_Mus
end
