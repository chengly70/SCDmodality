...
% well, Dcc1_m is NOT all (subset, combinatorial blowup!)

%%
load('Reslt_Trips.mat','DbstOB_u','Dlda_u','Dop_u','Dcc1_m')
...
% LDA applied to 'all' trips of aPC
...
% 'subset' CCA algorithm without any filtering 
figure('Renderer', 'Painters');
hold on
...
hold on
histogram(Dop_u{1},'Normalization','probability','BinWidth',bw,'BinEdges',edg,'FaceColor',ccD(2,:),'LineStyle','none')
plot(mean(Dop_u{1}),yHgh+.05,'.','color',ccD(2,:),'MarkerSize',12)
...
%% p-vals, effect sizes, for LDA, CCA, THEN Optim
