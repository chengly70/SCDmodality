% AFTER running getCalc_Trips_decode.m, running again to we can just
% append 2 new vars we want
...
save([pwd,'/Reslt_Trips'],'Dop_u','Dlda_u','-append')
